...
@cenum Status::Int32 begin
    ...
    STATUS_ERROR = -1
    STATUS_FATAL = -2
    STATUS_ERROR_UNIMPLEMENTED = -3
    STATUS_ERROR_NOT_SUPPORTED = -4
    STATUS_ERROR_INVALID_ARGUMENT = -5
    STATUS_ERROR_INVALID_ARGUMENT_SIZE = -6
    STATUS_ERROR_ALREADY_INITIALIZED = -7
    STATUS_ERROR_NOT_INITIALIZED = -8
    STATUS_ERROR_VERSION_MISMATCH = -9
    STATUS_ERROR_ALREADY_ATTACHED = -10
    STATUS_ERROR_INVALID_ARCHITECTURE_ID = -11
    STATUS_ERROR_ILLEGAL_INSTRUCTION = -12
    STATUS_ERROR_INVALID_CODE_OBJECT_ID = -13
    STATUS_ERROR_INVALID_ELF_AMDGPU_MACHINE = -14
    STATUS_ERROR_INVALID_PROCESS_ID = -15
    STATUS_ERROR_INVALID_AGENT_ID = -16
    STATUS_ERROR_INVALID_QUEUE_ID = -17
    STATUS_ERROR_INVALID_DISPATCH_ID = -18
    STATUS_ERROR_INVALID_WAVE_ID = -19
    STATUS_ERROR_WAVE_NOT_STOPPED = -20
    STATUS_ERROR_WAVE_STOPPED = -21
    STATUS_ERROR_WAVE_OUTSTANDING_STOP = -22
    STATUS_ERROR_WAVE_NOT_RESUMABLE = -23
    STATUS_ERROR_INVALID_DISPLACED_STEPPING_ID = -24
    STATUS_ERROR_DISPLACED_STEPPING_BUFFER_UNAVAILABLE = -25
    STATUS_ERROR_INVALID_WATCHPOINT_ID = -26
    STATUS_ERROR_NO_WATCHPOINT_AVAILABLE = -27
    STATUS_ERROR_INVALID_REGISTER_CLASS_ID = -28
    STATUS_ERROR_INVALID_REGISTER_ID = -29
    STATUS_ERROR_INVALID_LANE_ID = -30
    STATUS_ERROR_INVALID_ADDRESS_CLASS_ID = -31
    STATUS_ERROR_INVALID_ADDRESS_SPACE_ID = -32
    STATUS_ERROR_MEMORY_ACCESS = -33
    STATUS_ERROR_INVALID_ADDRESS_SPACE_CONVERSION = -34
    STATUS_ERROR_INVALID_EVENT_ID = -35
    STATUS_ERROR_INVALID_SHARED_LIBRARY_ID = -36
    STATUS_ERROR_INVALID_BREAKPOINT_ID = -37
    STATUS_ERROR_CLIENT_CALLBACK = -38
    STATUS_ERROR_INVALID_CLIENT_PROCESS_ID = -39
    STATUS_ERROR_PROCESS_EXITED = -40
    STATUS_ERROR_LIBRARY_NOT_LOADED = -41
    STATUS_ERROR_SYMBOL_NOT_FOUND = -42
    STATUS_ERROR_INVALID_ADDRESS = -43
end
